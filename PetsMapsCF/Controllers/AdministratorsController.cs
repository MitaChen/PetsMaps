...
namespace PetsMapsCF.Controllers
{
    ...
    public class AdministratorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdminID,AdminName,AdminPassword,AdminPermission")] Administrators administrators)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdminID,AdminName,AdminPassword,AdminPermission")] Administrators administrators)
        {
            if (ModelState.IsValid)
            {
